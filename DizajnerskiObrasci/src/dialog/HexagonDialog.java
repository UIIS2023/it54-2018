...
public class HexagonDialog extends JDialog implements Validable {
	...
	public HexagonDialog() {
		...
		btnColor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Color hexagonColor = JColorChooser.showDialog(getContentPane(), "Choose a color", Color.BLACK);
				
				if (hexagonColor != null) {
					txtColor.setBackground(hexagonColor);
				}
			}
		});
		...
		btnInnerColor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Color hexagonColor = JColorChooser.showDialog(getContentPane(), "Choose a color", Color.WHITE);
				
				if (hexagonColor != null) {
					txtInnerColor.setBackground(hexagonColor);
				}
			}
		});
